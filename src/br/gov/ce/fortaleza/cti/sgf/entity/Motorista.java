...
@Table(name="tb_pessoamotorista" , schema= "TESTE")
@NamedQueries({
	...
	@NamedQuery(name = "Motorista.findPessoaByCPF", query = "select u from Motorista u where u.pessoa.cpf = ?"),
	@NamedQuery(name = "Motorista.findByUG", query = "select u from Motorista u where u.pessoa.ua.ug.id = ? order by u.pessoa.nome"),
	@NamedQuery(name = "Motorista.findByUGStatus", query = "select u from Motorista u where u.pessoa.ua.ug.id = ? and u.ativo = ? order by u.codMotorista desc")
})
