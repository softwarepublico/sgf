...
public class SolicitacaoLubrificanteBean extends
	...
	public String loadList() {
		...
		Veiculo veiculo = (this.placa != null && this.placa != "") ? veiculoService
				.findByPlacaSingle(this.placa.toUpperCase())
				: new Veiculo();
		...
		if (SgfUtil.isOperador(user)) {
			...
			this.entities = service.findSolicitacoes(this.searchId, veiculo
					.getId(), posto.getCodPosto(), this.dtInicial, this.dtFinal, null);
			...
			this.entities = service.findSolicitacoes(this.searchId, veiculo
					.getId(), null, this.dtInicial, this.dtFinal, this.orgao);
